...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    public static final String DATABASE_NAME = "datakaryawan.db";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerDepartement = findViewById(R.id.spinnerDepartment);
    ...
    private void addEmployee() {
        ...
        String dept = spinnerDepartement.getSelectedItem().toString();
